...
def prompt_student_data(existing_students):
    ...
    return Student(
        full_name,
        section,
        prompt_valid_grade("Enter the Spanish grade: "),
        prompt_valid_grade("Enter the English grade: "),
        prompt_valid_grade("Enter the Social Studies grade: "),
        prompt_valid_grade("Enter the Science grade: "),
    )
